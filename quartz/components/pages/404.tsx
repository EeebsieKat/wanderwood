...
const NotFound: QuartzComponent = ({ cfg, ctx }: QuartzComponentProps) => {
  ...
  return (
    <article class="popover-hint" style="text-align: center;">
      <h2 style="font-family: monospace;">404 - Lost in the Wanderwood!</h2>
      <p style="font-family: monospace;">Your Mob Buddy got separated from the pack. Guide them back to safety!</p>

      <canvas 
        id="flappyCanvas" 
        width="340" 
        height="460" 
        style="border: 2px solid #7aa2f7; background: #16161e; border-radius: 10px; cursor: pointer; margin: 15px auto; display: block;"
      ></canvas>

      <p style="font-size: 0.85rem; color: #cfc9c2; font-family: monospace; margin-bottom: 15px;">
        Press <b>SPACE</b> or <b>CLICK</b> to Flap | Click to Retry
      </p>

      <a href={baseDir} style="color: #7dcfff; text-decoration: underline; font-family: monospace;">
      ...
      <script
        dangerouslySetInnerHTML={{
          __html: `
          // 1. Quartz Native Redirect Handler
